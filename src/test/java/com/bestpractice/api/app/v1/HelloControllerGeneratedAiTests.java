...
public class HelloControllerGeneratedAiTests {
    ...
    @BeforeEach
    void setUp() {
        // GIVEN: initialize HelloController before each test
    ...
    void sample1_shouldReturnHelloWorldMap() {
        ...
        // THEN: verify the returned map contains expected key and value
        assertNotNull(result, "Result map should not be null");
        assertEquals(1, result.size(), "Result map should contain exactly one entry");
        assertEquals("Hello world.", result.get("key"), "Value for key 'key' should be 'Hello world.'");
    }
    ...
    void sample1_shouldNotThrowAnyException() {
        ...
        assertDoesNotThrow(() -> {
            ...
            assertNotNull(result, "Result map should not be null");
            assertEquals("Hello world.", result.get("key"), "Value for key 'key' should be 'Hello world.'");
        }, "sample1 should not throw any exception");
    }
}
