...
public class AuthControllerGeneratedAiTests {
    ...
    @Test
    void login_withEmailRequest_shouldReturnAuthResponse_whenValidRequest() {
        // GIVEN
    ...
    @Test
    void login_withEmailRequest_shouldThrowBadRequest_whenValidationFails() {
        // GIVEN
        AuthByEmailRequest request = new AuthByEmailRequest();
    ...
    @Test
    void login_withRefreshTokenRequest_shouldReturnAuthResponse_whenValidRequest() {
        // GIVEN
    ...
    @Test
    void login_withRefreshTokenRequest_shouldThrowBadRequest_whenValidationFails() {
        // GIVEN
        AuthByRefreshTokenRequest request = new AuthByRefreshTokenRequest();
        when(bindingResult.hasErrors()).thenReturn(true);
