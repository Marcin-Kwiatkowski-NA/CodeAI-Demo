...
class AuthControllerGeneratedAiTests {
    ...
    void optionsAuth_shouldReturnAllowedMethodsAndHeaders() {
        ...
        assertThat(response.getHeaders().get("Allow")).contains("POST,OPTIONS");
        assertThat(response.getHeaders().get("Access-Control-Allow-Origin")).contains("*");
        assertThat(response.getBody()).isNull();
    }

    @Test
    void login_withEmailAndPassword_shouldReturnAuthResponse() {
        // GIVEN
    ...
    @Test
    void login_withEmailAndPassword_shouldThrowBadRequestWhenValidationFails() {
        // GIVEN
        AuthByEmailRequest request = new AuthByEmailRequest();
