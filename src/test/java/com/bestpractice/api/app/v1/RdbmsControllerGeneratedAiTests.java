...
class RdbmsControllerGeneratedAiTests {
    ...
    void testPostInfo() throws URISyntaxException {
        ...
        assertThat(result.getHeaders().getLocation()).isEqualTo(new URI("/api/v1/infos/1"));
    ...
    void testDeleteInfo() {
        ...
        // THEN
        assertThat(result).isNotNull();
        assertThat(result).containsEntry("message", "ok        verify(infoService, times(1)).deleteInfo(id);
    }
}
