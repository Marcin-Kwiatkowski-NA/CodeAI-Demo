...
class RdbmsControllerGeneratedAiTests {
    ...
    @BeforeEach
    void setUp() {
        sampleResponse = new InfoResponse("1", "title", "description");
        sampleRequest = new InfoRequest();
        sampleRequest.setTitle("title");
        sampleRequest.setDescription("description");
    }
    ...
    void getInfos_shouldReturnListOfInfoResponses() {
        ...
        verify(infoService, Mockito.times(1)).getInfos();
    }
    ...
    void getInfo_shouldReturnSingleInfoResponse() {
        ...
        verify(infoService, Mockito.times(1)).getInfo("1");
    }
    ...
    void postInfo_shouldReturnCreatedResponseEntity() throws URISyntaxException {
        ...
        verify(infoService, Mockito.times(1)).generateInfo(any(InfoRequest.class));
    }

    @Test
    void putInfo_shouldReturnUpdatedInfoResponse() {
        // GIVEN
        when(infoService.updateInfo(eq("1"), any(InfoRequest.class))).thenReturn(sampleResponse);
        ...
        verify(infoService, Mockito.times(1)).updateInfo(eq("1"), any(InfoRequest.class));
    }
    ...
    void deleteInfo_shouldReturnOkMessage() {
        ...
        verify(infoService, Mockito.times(1)).deleteInfo("1");
    }
}