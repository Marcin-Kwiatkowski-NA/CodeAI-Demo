...
public class UserControllerGeneratedAiTests {
    ...
    @Test
    public void givenBindingResultThrowsRuntimeException_whenCreateUser_thenPropagatesException() {
        // GIVEN
        UserRequest request = new UserRequest();
        request.setUsername("user");
        request.setEmail("user@example.com");
        request.setPassword("password");
        Mockito.when(bindingResult.hasErrors()).thenThrow(new RuntimeException("Unexpected error"));
    ...
    @Test
    public void givenUserServiceThrowsRuntimeException_whenCreateUser_thenPropagatesException() {
        // GIVEN
        UserRequest request = new UserRequest();
        request.setUsername("user");
        request.setEmail("user@example.com");
        request.setPassword("password");
        Mockito.when(bindingResult.hasErrors()).thenReturn(false);
        Mockito.when(userService.generateUser(request)).thenThrow(new RuntimeException("Service failure"));
