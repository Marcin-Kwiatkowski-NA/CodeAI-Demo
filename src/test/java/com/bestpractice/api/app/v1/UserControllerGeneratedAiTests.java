...
public class UserControllerGeneratedAiTests {
    ...
    public void givenValidUserRequest_whenCreateUser_thenReturnsUserResponse() {
        ...
        Mockito.when(userService.generateUser(request)).thenReturn(expectedResponse);
    ...
    public void givenInvalidUserRequest_whenCreateUser_thenThrowsBadRequest() {
        ...
        Mockito.when(bindingResult.getObjectName()).thenReturn("userRequest");
    ...
    @Test
    public void givenServiceThrowsRuntimeException_whenCreateUser_thenPropagatesException() {
        // GIVEN
        UserRequest request = new UserRequest();
        request.setUsername("testuser");
        request.setEmail("test@example.com");
        ...
        Mockito.when(userService.generateUser(request)).thenThrow(serviceException);
    ...
    @Test
    public void givenBindingResultHasErrorsWithNullMessage_whenCreateUser_thenThrowsBadRequestWithNullMessage() {
        // GIVEN
        UserRequest request = new UserRequest();
        request.setUsername("testuser");
        request.setEmail("test@example.com");
        ...
        BindingResult bindingResult = Mockito.mock(BindingResult.class);
        Mockito.when(bindingResult.hasErrors()).thenReturn(true);
        Mockito.when(bindingResult.getObjectName()).thenReturn(null);
    ...
    @Test
    public void givenBindingResultHasErrors_whenCreateUser_thenDoesNotCallUserService() {
        // GIVEN
        UserRequest request = new UserRequest();
        request.setUsername("testuser");
        request.setEmail("test@example.com");
        ...
        // THEN
        Mockito.verify(userService, Mockito.never()).generateUser(Mockito.any(UserRequest.class));
    }

    @Test
    public void givenValidUserRequest_whenServiceReturnsNull_thenReturnsNull() {
        // GIVEN
        UserRequest request = new UserRequest();
        request.setUsername("testuser");
        request.setEmail("test@example.com");
        ...
        BindingResult bindingResult = Mockito.mock(BindingResult.class);
        Mockito.when(bindingResult.hasErrors()).thenReturn(false);
        Mockito.when(userService.generateUser(request)).thenReturn(null);
