...
class AdviceControllerGeneratedAiTests {
    ...
    @Test
    void givenNoHandlerFoundExceptionWithValidPath_whenHandled_thenReturnsNotFoundErrorResponse() {
        // GIVEN
        NoHandlerFoundException exception = new NoHandlerFoundException("POST", "/valid-path", null);
