...
public class AdviceControllerGeneratedAiTests {
    ...
    void testBadRequest() {
        // GIVEN
        BadRequest exception = new BadRequest("Invalid input");
    ...
    void testNotFound01() {
        // GIVEN
        NoHandlerFoundException exception = new NoHandlerFoundException("GET", "/invalid", null);
    ...
    void testServerErrorHandlesRuntimeException() {
        // GIVEN
        RuntimeException runtimeException = new RuntimeException("Simulated runtime error");
    ...
    void testServerErrorHandlesNullExceptionGracefully() {
        ...
        // WHEN
        ErrorResponse response = adviceController.serverError(new Exception("Null simulation"));
