...
public class AdviceControllerGeneratedAiTests {
    ...
    void badRequest() {
        ...
        // WHEN: The controller handles the BadRequest exception
    ...
    void unAuthorized() {
        ...
        // WHEN: The controller handles the UnAuthorized exception
    ...
    void forbidden() {
        ...
        // WHEN: The controller handles the Forbidden exception
    ...
    void notFound01() {
        ...
        // WHEN: The controller handles the NoHandlerFoundException
    ...
    void notFound02() {
        ...
        // WHEN: The controller handles the NotFound exception
        // THEN: The shareNotFound() method is called and its result is returned.
    ...
    void conflict() {
        ...
        // WHEN: The controller handles the Conflict exception
