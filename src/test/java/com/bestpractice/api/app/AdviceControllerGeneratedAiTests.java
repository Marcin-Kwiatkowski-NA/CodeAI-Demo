...
class AdviceControllerGeneratedAiTests {
    ...
    @Test
    void givenUnhandledRuntimeException_whenHandled_thenReturnsInternalServerErrorResponse() {
        // GIVEN
        RuntimeException runtimeException = new RuntimeException("Unhandled runtime exception");
