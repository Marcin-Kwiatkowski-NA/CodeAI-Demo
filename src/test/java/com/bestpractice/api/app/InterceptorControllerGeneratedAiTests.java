...
public class InterceptorControllerGeneratedAiTests {
    ...
    @Test
    void givenErrorPath_whenPreHandle_thenReturnFalse() throws IOException {
        // GIVEN
    ...
    @Test
    void givenNoAuthorizationHeader_whenPreHandle_thenThrowUnAuthorized() {
        // GIVEN
    ...
    @Test
    void givenInvalidBearerFormat_whenPreHandle_thenThrowUnAuthorized() {
        // GIVEN
        when(request.getRequestURI()).thenReturn("/api/v1/secure");
        when(request.getMethod()).thenReturn("GET");
    ...
    @Test
    void givenValidBearerToken_whenPreHandle_thenReturnTrue() throws IOException {
        // GIVEN
        when(request.getRequestURI()).thenReturn("/api/v1/secure");
        when(request.getMethod()).thenReturn("GET");
    ...
    @Test
    void givenLocalProfile_whenPreHandle_thenSkipAuthAndReturnTrue() throws IOException {
        // GIVEN
        when(request.getRequestURI()).thenReturn("/api/v1/secure");
        when(request.getMethod()).thenReturn("GET");
    ...
    @Test
    void givenDisableAuthEndpoint_whenPreHandle_thenReturnTrueWithoutAuth() throws IOException {
        // GIVEN
