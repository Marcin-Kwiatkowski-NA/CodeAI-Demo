...
public class InterceptorControllerGeneratedAiTests {
    ...
    @Test
    void preHandle_shouldDecodeJwtAndSetRequestInfo_whenBearerTokenValid() throws IOException {
        // GIVEN
        when(request.getRequestURI()).thenReturn("/api/v1/secure");
        when(request.getMethod()).thenReturn("GET");
    ...
    @Test
    void preHandle_shouldSkipAuth_whenLocalProfile() throws IOException {
        // GIVEN
        when(request.getRequestURI()).thenReturn("/api/v1/secure");
        when(request.getMethod()).thenReturn("GET");
