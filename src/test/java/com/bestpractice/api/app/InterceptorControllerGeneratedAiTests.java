package com.com.com.bestpractice.api.app;
...
import org.springframework.web.servlet.handler.Interceptor;
import org.springframework.web.servlet.ModelAndView;

public class InterceptorController implements Interceptor {
  ...
  public InterceptorController(AuthComponent authComponent, RequestInfoComponent requestInfoComponent) {
  ...
  public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws IOException {
    ...
    if (!this.requestInfo.getPath().startsWith(SPRING_ERROR_PATH) && !this.requestInfo.getPath().contains(DISABLE_AUTH_ENDPOINTS) && !this.requestInfo.getUserId()) {
