...
public class UtilGeneratedAiTests {
    ...
    void testDeepClone_ShouldThrowClassNotFoundExceptionForInvalidStream() throws IOException {
        // GIVEN
        // This test ensures that ClassNotFoundException is properly handled when deserialization fails.
        // We simulate this by creating a corrupted byte stream manually.
