...
@DisplayNameGenerator(Implementation.class)
class CredentialPropertyGeneratedAiTests {
    ...
    void convertToIntExpires_NullHourStr() {
        // GIVEN a new CredentialProperty instance with a null hour string
        // WHEN the convertToIntExpires() method is called
        // THEN the method should return null
