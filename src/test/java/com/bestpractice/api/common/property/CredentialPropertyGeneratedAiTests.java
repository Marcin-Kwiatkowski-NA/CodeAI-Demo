...
public class CredentialPropertyGeneratedAiTests {
    ...
    void testDefaultValues() {
        // GIVEN
        // property is instantiated in setUp

        // THEN
        assertThat(property.getKey()).isNull();
        assertThat(property.getProvider()).isNull();
        assertThat(property.getSubject()).isNull();
        assertThat(property.getAlg()).isNull();
        assertThat(property.getHmacSecret()).isNull();
        assertThat(property.getExpiresHourStr()).isNull();
    }
    ...
    @Test
    void testConvertToIntExpiresWithHyphen() {
        // GIVEN
    ...
    @Test
    void testConvertToIntExpiresWithNonNumeric() {
        // GIVEN
        property.setExpiresHourStr("abc");
    ...
    @Test
    void testConvertToIntExpiresWithMixedCharacters() {
        // GIVEN
        property.setExpiresHourStr("12abc");
    ...
    void testConvertToIntExpiresWithLeadingZeros() {
        // GIVEN
        property.setExpiresHourStr("0012");
    ...
    @Test
    void testConvertToIntExpiresWithNullValue() {
        // GIVEN
