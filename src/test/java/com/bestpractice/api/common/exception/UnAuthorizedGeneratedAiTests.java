...
public class UnAuthorizedGeneratedAiTests {
    ...
    void constructor_no_args() {
        ...
        // THEN: The UnAuthorized object is created with no message.
    ...
    void constructor_with_message() {
        ...
        // THEN: The UnAuthorized object is created with the specified message.
    ...
    void constructor_with_message_and_cause() {
        ...
        Throwable cause = new Exception("Authentication failed");
