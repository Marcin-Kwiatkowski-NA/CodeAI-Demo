...
class NotFoundGeneratedAiTests {
    ...
    void givenNoArguments_whenConstructorCalled_thenExceptionCreated() {
        ...
        // THEN: Exception is created and message is null
    ...
    void givenEmptyMessage_whenConstructorCalled_thenExceptionCreatedWithEmptyMessage() {
        ...
        // THEN: Exception is created with an empty message
        assertNotNull(notFound);
        assertEquals(message, notFound.getMessage());
    }

    @Test
    void givenValidMessageAndNullCause_whenConstructorCalled_thenExceptionCreatedWithValidMessageAndNullCause() {
        // GIVEN: A valid message and a null cause
        String message = "Valid message";
        Throwable cause = null;

        // WHEN: Constructor is called with the valid message and null cause
        notFound = new NotFound(message, cause);

        // THEN: Exception is created with the valid message and a null cause
        assertNotNull(notFound);
        assertEquals(message, notFound.getMessage());
        assertNull(notFound.getCause());
    }
    ...
    @Test
    void givenNullMessageAndValidCause_whenConstructorCalled_thenExceptionCreatedWithNullMessageAndValidCause() {
        // GIVEN: A null message and a valid cause
        String message = null;
        Throwable cause = new IllegalArgumentException("Valid cause");

        // WHEN: Constructor is called with the null message and        // valid cause
        notFound = new NotFound(message, cause);

        // THEN: Exception is created with a null message and the valid cause
        assertNotNull(notFound);
        assertNull(notFound.getMessage());
        assertEquals(cause, notFound.getCause());
    }
    ...
    @Test
    void givenValidMessageAndValidCause_whenConstructorCalled_thenExceptionCreatedWithValidMessageAndValidCause() {
        // GIVEN: A valid message and a valid cause
        String message = "Valid message";
        Throwable cause = new IllegalArgumentException("Valid cause");

        // WHEN: Constructor is called with the valid message and valid cause
        notFound = new NotFound(message, cause);

        // THEN: Exception is created with the valid message and the valid cause
        assertNotNull(notFound);
        assertEquals(message, notFound.getMessage());
        assertEquals(cause, notFound.getCause());
    }
