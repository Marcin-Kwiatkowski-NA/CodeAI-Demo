...
class RequestTimeoutGeneratedAiTests {
    ...
    @Test
    void givenNullCause_whenConstructorCalled_thenInstanceCreatedWithMessageOnly() {
        ...
        // THEN: Instance should be created with the provided message and null cause
        assertNotNull(requestTimeout);
        assertEquals(message, requestTimeout.getMessage());
        assertNull(requestTimeout.getCause());
    }
    ...
    @Test
    void givenNullMessage_whenConstructorCalled_thenInstanceCreatedWithCauseOnly() {
        ...
        // THEN: Instance should be created with null message and the provided cause
        assertNotNull(requestTimeout);
        assertNull(requestTimeout.getMessage());
        assertEquals(cause, requestTimeout.getCause());
    }
