...
public class AuthByRefreshTokenRequestGeneratedAiTests {
    ...
    void givenEmptyRefreshToken_whenSetRefreshToken_thenGetRefreshTokenReturnsEmptyString() {
        ...
        // THEN: The refresh token should be retrievable and return an empty string
        assertThat(authByRefreshTokenRequest.getRefreshToken()).isEqualTo(emptyRefreshToken);
    }
}
