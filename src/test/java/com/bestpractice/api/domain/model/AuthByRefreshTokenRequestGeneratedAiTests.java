...
public class AuthByRefreshTokenRequestGeneratedAiTests {
    ...
    @Test
    void givenNullRefreshToken_whenSetRefreshToken_thenNoExceptionIsThrown() {
        // GIVEN: A null refresh token
        String nullRefreshToken = null;
    ...
    @Test
    void givenValidRefreshToken_whenSetRefreshTokenMultipleTimes_thenGetRefreshTokenReturnsLatestValue() {
        // GIVEN: Multiple valid refresh tokens
        String firstRefreshToken = "firstToken";
        String secondRefreshToken = "secondToken";

        // WHEN: Setting the refresh token multiple times
        authByRefreshTokenRequest.setRefreshToken(firstRefreshToken);
        authByRefreshTokenRequest.setRefreshToken(secondRefreshToken);

        // THEN: The refresh token should return the latest set value
        assertEquals(secondRefreshToken, authByRefreshTokenRequest.getRefreshToken());
    }
}
