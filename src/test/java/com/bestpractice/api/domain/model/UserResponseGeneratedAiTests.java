...
class UserResponseGeneratedAiTests {
    ...
    void getId_returnsId() {
        ...
        // THEN the getId() method returns the correct id
        assertEquals("123", id);
    }
    ...
    void getUsername_returnsUsername() {
        ...
        // THEN the getUsername() method returns the correct username
    ...
    void getEmail_returnsEmail() {
        ...
        // THEN the getEmail() method returns the correct email
    ...
    void setUp() {
        ...
        // It's not strictly necessary in this simple example, but it's good practice
