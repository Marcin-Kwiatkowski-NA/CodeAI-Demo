...
public class UserResponseGeneratedAiTests {
    ...
    @Test
    void givenUserResponseObject_whenGetId_thenReturnsCorrectId() {
    ...
    @Test
    void givenUserResponseObject_whenGetUsername_thenReturnsCorrectUsername() {
    ...
    @Test
    void givenUserResponseObject_whenGetEmail_thenReturnsCorrectEmail() {
