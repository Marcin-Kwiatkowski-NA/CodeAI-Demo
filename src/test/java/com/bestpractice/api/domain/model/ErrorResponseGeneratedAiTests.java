...
class ErrorResponseGeneratedAiTests {
    ...
    void getStatusAndsetErrorAndsetMessage() {
        // GIVEN: A new ErrorResponse object is created.
        // WHEN: The getStatus(), setError(), and setMessage() methods are called.
        // THEN: The status, error, and message fields are set to their respective values.
        errorResponse.setStatus(500);
        errorResponse.setError("Internal Server Error");
        errorResponse.setMessage("Details about the error");
        assertEquals(500, errorResponse.getStatus());
        assertEquals("Internal Server Error", errorResponse.getError());
        assertEquals("Details about the error", errorResponse.getMessage());
    }
}
