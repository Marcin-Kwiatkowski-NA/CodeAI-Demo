...
class InfoResponseGeneratedAiTests {
  ...
  @BeforeEach
  void setUp() {
    // Set up the InfoResponse object with sample values.
  ...
  void getId_returnsCorrectId() {
    ...
    // THEN: The getId() method returns the correct ID "123".
  ...
  void getTitle_returnsCorrectTitle() {
    ...
    // THEN: The getTitle() method returns the correct title "Example Title".
  ...
  void getDescription_returnsCorrectDescription() {
    ...
    // THEN: The getDescription() method returns the correct description "This is a sample description.".
