...
class InfoRequestGeneratedAiTests {
    ...
    @BeforeEach
    void setUp() {
        // Reset the state of the InfoRequest object before each test
        // This ensures that tests are independent and reliable
        // You can add any necessary reset logic here
    }
}
