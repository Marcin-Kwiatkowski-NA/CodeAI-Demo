...
class DomainBeanGeneratedAiTests {
    ...
    void passwordEncoder_shouldCreateNewInstance() {
        ...
        // WHEN: We retrieve the password encoder from the DomainBean.
...
class MyExtension implements TestContext.TestContextFactory<MyExtension> {
    @Override
    public MyExtension createContext(TestContext context) {
