...
class InfoServiceImplGeneratedAiTests {
    ...
    @Test
    void givenInfoExists_whenGetInfo_thenReturnInfoResponse() {
        // GIVEN
        Info info = new Info();
        info.setId("1");
    ...
    @Test
    void givenInfoDoesNotExist_whenGetInfo_thenThrowInternalServerError() {
        // GIVEN
    ...
    @Test
    void givenValidRequest_whenUpdateInfo_thenReturnUpdatedInfoResponse() {
        // GIVEN
    ...
    @Test
    void givenInvalidRequest_whenUpdateInfo_thenThrowBadRequest() {
        // GIVEN
        when(infoRepository.findById("1")).thenThrow(new RuntimeException());
    ...
    @Test
    void givenValidId_whenDeleteInfo_thenInfoIsDeleted() {
        // GIVEN
