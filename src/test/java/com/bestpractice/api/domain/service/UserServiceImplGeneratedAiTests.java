...
class UserServiceImplGeneratedAiTests {
    ...
    void getAuthenticatedUser_shouldReturnUser_whenCredentialsAreValid() {
        ...
        verify(encryptionComponent).matchedPassword("encodedPw", "rawPw");
    }
    ...
    void generateUser_shouldThrowConflict_whenRepositoryThrowsConflict() {
        ...
        when(encryptionComponent.encodePassword("pw")).thenReturn("encodedPw");
    ...
    void getUserByEmail_shouldThrowInternalServerError_whenRepositoryThrowsException() {
        ...
        // WHEN / THEN
        assertThatThrownBy(() -> userService.getAuthenticatedUser("error@example.com", "pw"))
                .isInstanceOf(InternalServerError.class);
    }
}
