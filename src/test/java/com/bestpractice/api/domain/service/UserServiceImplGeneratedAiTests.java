...
public class UserServiceImplGeneratedAiTests {
    ...
    public void testGenerateUserThrowsInternalServerError() {
        ...
        User user = new User("1", "username", "email@example.com", "encodedPw");
        when(request.convert("1", "encodedPw")).thenReturn(user);
        when(userRepository.insert(user)).package com.bestpractice.api.domain.service;
...
public class UserServiceImplGeneratedAiTests {
    ...
    public void testGenerateUserThrowsInternalServerError() {
        ...
        User user = new User("1", "username", "email@example.com", "encodedPw");
        when(request.convert("1", "encodedPw")).thenReturn(user);
        when(userRepository.insert(user)).thenThrow(new RuntimeExceptionpackage com.bestpractice.api.domain.service;
