...
class AuthServiceImplGeneratedAiTests {
    ...
    void givenValidEmailAndPassword_whenLogin_thenReturnAuthResponse() {
        ...
        Credential token = new Credential("Bearer", "token123", new Date(), false);
        Credential refreshToken = new Credential("Bearer", "refreshToken123", new Date(), true);
    ...
    void givenValidRefreshToken_whenLogin_thenReturnAuthResponse() {
        ...
        User user = new User("1", "testUser", email, "encryptedPassword");
        Credential token = new Credential("Bearer", "token123", new Date(), false);
       Credential newRefreshToken = new Credential("Bearer", "newRefreshToken123", new Date(), true);
