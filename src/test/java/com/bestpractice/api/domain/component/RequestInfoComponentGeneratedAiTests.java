...
public class RequestInfoComponentGeneratedAiTests {
    ...
    void testMultipleFieldAssignments() {
        // GIVEN
        String expectedUserId = "multiUser";
        String expectedEmail = "multi@example.com";
        String expectedPath = "/multi";
        String expectedMethod = "GET";
        String expectedRequestId = "multi-001";
        boolean expectedRefreshToken = true;
        ...
        assertEquals(expectedRefreshToken, requestInfoComponent.isRefreshToken());
    }
}
