...
class AuthComponentGeneratedAiTests {
    ...
    @BeforeEach
    void setUp() {
        credentialProperty = mock(CredentialProperty.class);
    ...
    @Test
    void givenValidUserDetails_whenGenerateJwt_thenReturnCredentialWithExpectedValues() {
        // GIVEN
    ...
    @Test
    void givenRefreshTokenRequest_whenGenerateJwt_thenReturnCredentialWithRefreshTrue() {
        // GIVEN
        String userId = "user123";
        String email = "user@example.com";
