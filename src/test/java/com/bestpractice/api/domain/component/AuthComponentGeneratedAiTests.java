...
class AuthComponentGeneratedAiTests {
    ...
    static void initializeStaticResources() {
        // Initialize any static resources or configurations required for the tests
    }
    ...
    void setUp() {
        ...
        Mockito.when(credentialProperty.convertToIntExpires()).thenReturn(2);
        authComponent = new AuthComponent(credentialProperty);
    }

    @AfterEach
    void cleanUpAfterEachTest() {
        // Clean up resources or reset states after each test execution
    }

    @AfterAll
    static void cleanUpStaticResources() {
        // Clean up static resources or configurations after all tests are executed
    }
    ...
    @Test
    void generateJwt_validInputs_shouldReturnCredential() {
        // GIVEN
        String userId = "12345";
    ...
    @Test
    void generateJwt_refreshToken_shouldReturnCredentialWithRefreshTrue() {
        // GIVEN
        String userId = "12345";
        String email = "test@example.com";
