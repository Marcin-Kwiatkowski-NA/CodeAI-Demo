...
class BCryptPasswordEncryptionComponentGeneratedAiTests {
    ...
    @BeforeEach
    void setUp() {
        // Corrected: Initialize the component directly without mocking the PasswordEncoder
    ...
    void givenRawPassword_whenEncodePassword_thenReturnEncodedPassword() {
        ...
        assertThat(result).isNotEqualTo(rawPassword); // Encoded password should differ from raw password
    }
