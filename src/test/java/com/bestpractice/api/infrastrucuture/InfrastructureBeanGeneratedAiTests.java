...
public class InfrastructureBeanGeneratedAiTests {
    ...
    @BeforeEach
    void setUp() {
        // Reset mocks implicitly handled by MockitoExtension
    }

    @Test
    void givenLocalDbRepository_whenCreateBeans_thenBeansAreNotNull() {
        // GIVEN
    ...
    @Test
    void givenRdbmsDbRepository_whenCreateBeans_thenBeansAreNotNull() throws Exception {
        // GIVEN
        ...
        DataSourceTransactionManager txManager = repository.transactionManager();
    ...
    @Test
    void givenCassandraDbRepository_whenCreateBeans_thenBeansAreNotNull() {
        // GIVEN
    ...
    @Test
    void givenMongoDbRepository_whenCreateBeans_thenBeansAreNotNull() {
        // GIVEN
    ...
    @Test
    void givenRedisCacheRepository_whenConstruct_thenNoException() {
        // GIVEN
        InfrastructureBean.RedisCacheRepository repository;

        // WHEN
        repository = new InfrastructureBean.RedisCacheRepository(redisProperty);
    ...
    @Test
    void givenLocalCacheRepository_whenConstruct_thenNoException() {
        // GIVEN
        InfrastructureBean.LocalCacheRepository repository;

        // WHEN
        repository = new InfrastructureBean.LocalCacheRepository();
