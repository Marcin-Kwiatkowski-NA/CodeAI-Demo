...
public class InfrastructureBeanGeneratedAiTests {
    ...
    void givenRdbmsProfile_whenCreateRepositories_thenReturnRdbmsRepositories() throws Exception {
        ...
        setPrivateField(repository, "url", "jdbc:h2:mem:test");
    ...
    @Test
    void givenRedisProfile_whenCreateRedisCacheRepository_thenRepositoryCreated() {
        // GIVEN
    ...
    @Test
    void givenLocalCacheProfile_whenCreateLocalCacheRepository_thenRepositoryCreated() {
        // GIVEN
        InfrastructureBean.LocalCacheRepository repository = new InfrastructureBean.LocalCacheRepository();

        // WHEN
        InfrastructureBean.LocalCacheRepository result = repository;
