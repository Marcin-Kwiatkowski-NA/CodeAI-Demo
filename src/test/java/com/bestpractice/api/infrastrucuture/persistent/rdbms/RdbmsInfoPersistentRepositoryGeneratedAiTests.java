...
public class RdbmsInfoPersistentRepositoryGeneratedAiTests implements IdGenerator {

    private final JdbcTemplate jdbcTemplate;

    public RdbmsInfoPersistentRepositoryGeneratedAiTests(JdbcTemplate jdbcTemplate) {
