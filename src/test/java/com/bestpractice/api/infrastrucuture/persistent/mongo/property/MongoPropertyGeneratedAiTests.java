...
public class MongoPropertyGeneratedAiTests {
    ...
    void testSetAuthDatabaseWithNullValue() {
        // GIVEN: a null auth database value
        String nullAuthDb = null;

        // WHEN: setting the auth database to null
        mongoProperty.setAuthDatabase(nullAuthDb);

        // THEN: the retrieved auth database should be null
        assertEquals(nullAuthDb, mongoProperty.getAuthDatabase());
    }

    @Test
    void testSetPlatformDatabaseWithNullValue() {
        // GIVEN: a null platform database value
        String nullPlatformDb = null;

        // WHEN: setting the platform database to null
        mongoProperty.setPlatformDatabase(nullPlatformDb);

        // THEN: the retrieved platform database should be null
        assertEquals(nullPlatformDb, mongoProperty.getPlatformDatabase());
    }

    @Test
    void testSetUserWithNullValue() {
        // GIVEN: a null user value
        String nullUser = null;

        // WHEN: setting the user to null
