...
public class MongoInfoPersistentRepositoryGeneratedAiTests implements InfoPersistentRepository {
  ...
  public MongoInfoPersistentRepositoryGeneratedAiTests(MongoClient mongoClient, MongoDatabase mongoDatabase) {
