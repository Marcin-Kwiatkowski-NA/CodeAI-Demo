...
public class MongoUserPersistentRepositoryGeneratedAiTests {
    ...
    public void testFindByEmailReturnsUser() {
        // GIVEN
        MongoUserEntity mongoUserEntity = new MongoUserEntity(new ObjectId(), "username", "email@test.com", "pass");
    ...
    public void testFindByIdReturnsUser() {
        ...
        MongoUserEntity mongoUserEntity = new MongoUserEntity(oid, "username", "email@test.com", "pass");
        com.mongodb.client.FindIterable<MongoUserEntity> iterable = mock(com.mongodb.client.FindIterable.class);
        when(iterable.first()).thenReturn(mongoUserEntity);
        when(collection.find(any())).thenReturn(iterable);
    ...
    @Test
    public void testInsertReturnsUser() {
        // GIVEN
        User user = new User(new ObjectId().toString(), "username", "email@test.com", "pass");
    ...
    @Test
    public void testReplaceReturnsUser() {
        // GIVEN
        User user = new User(new ObjectId().toString(), "username", "email@test.com", "pass");
