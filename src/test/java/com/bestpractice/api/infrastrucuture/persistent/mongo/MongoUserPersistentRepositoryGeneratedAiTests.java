...
public class MongoUserPersistentRepositoryGeneratedAiTests {
    ...
    public void testFindByEmailReturnsUser() {
        ...
        when(collection.find(any())).thenReturn(Mockito.mock(com.mongodb.client.FindIterable.class));
        com.mongodb.client.FindIterable<MongoUserEntity> iterable = collection.find(any());
    ...
    @Test
    public void testFindByEmailThrowsInternalServerErrorWhenExceptionOccurs() {
        // GIVEN
    ...
    public void testFindByIdReturnsUser() {
        ...
        MongoUserEntity entity = new MongoUserEntity(oid, "user1", "email@test.com", "pass");
        when(collection.find(any())).thenReturn(Mockito.mock(com.mongodb.client.FindIterable.class));
        com.mongodb.client.FindIterable<MongoUserEntity> iterable = collection.find(any());
        when(iterable.first()).thenReturn(entity);

        // WHEN
        User result = repository.findById(oid.toString());
    ...
    @Test
    public void testFindByIdThrowsInternalServerErrorWhenExceptionOccurs() {
        // GIVEN
        when(collection.find(any())).thenThrow(new RuntimeException("DB error"));
    ...
    public void testInsertUserSuccess() {
        // GIVEN
        User user = new User(new ObjectId().toString(), "user1", "email@test.com", "pass");
    ...
    @Test
    public void testInsertUserThrowsInternalServerErrorOnException() {
        // GIVEN
        User user = new User(new ObjectId().toString(), "user1", "email@test.com", "pass");
    ...
    @Test
    public voidpackage com.bestpractice.api.infrastrucuture.persistent.mongo;
...
public class MongoUserPersistentRepositoryGeneratedAiTests {
    ...
    public void testFindByEmailReturnsUser() {
        // GIVEN
        MongoUserEntity entity = new MongoUserEntity(new ObjectId(), "user1", "email@test.com", "pass");
        com.mongodb.client.FindIterable<MongoUserEntity> iterable = mock(com.mongodb.client.FindIterable.class);
    ...
    @Test
    public void testReplaceUserThrowspackage com.bestpractice.api.infrastrucuture.persistent.mongo;
...
public class MongoUserPersistentRepositoryGeneratedAiTests {
    ...
    @Test
    public void testReplaceUserThrowsInternalServerErrorOnExceptionpackage com.bestpractice.api.infrastrucuture.persistent.mongo;
