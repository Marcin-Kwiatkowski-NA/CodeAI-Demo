...
class RdbmsUserPersistentRepositoryGeneratedAiTests {
    ...
    void findByEmail_ShouldReturnUser_WhenUserExists() {
        ...
        when(jdbcTemplate.queryForObject(anyString(), (Class<User>) User.class, eq(email)))
        ...
        verify(jdbcTemplate, times(1)).queryForObject(anyString(), (Class<User>) User.class, eq(email));
    }
    ...
    void findById_ShouldReturnUser_WhenUserExists() {
        ...
        when(jdbcTemplate.queryForObject(anyString(), (Class<User>) User.class, eq(id)))
                .thenReturn(expectedUser);
        ...
        verify(jdbcTemplate, times(1)).queryForObject(anyString(), (Class<User>) User.class, eq(id));
    }
