...
class RdbmsUserPersistentRepositoryGeneratedAiTests {
    ...
    void findByEmail_ShouldReturnUser_WhenEmailExists() {
        ...
        when(jdbcTemplate.queryForObject(anyString(), (Class<User>) any(), eq(email)))
        ...
        verify(jdbcTemplate, times(1)).queryForObject(anyString(), (Class<User>) any(), eq(email));
    }
    ...
    void findById_ShouldReturnUser_WhenIdExists() {
        ...
        when(jdbcTemplate.queryForObject(anyString(), (Class<User>) any(), eq(id)))
                .thenReturn(expectedUser);
        ...
        verify(jdbcTemplate, times(1)).queryForObject(anyString(), (Class<User>) any(), eq(id));
    }
