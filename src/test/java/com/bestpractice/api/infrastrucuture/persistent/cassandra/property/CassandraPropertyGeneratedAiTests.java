...
class CassandraPropertyGeneratedAiTests {
    ...
    void setKeyspace() {
        // GIVEN: CassandraProperty object is created.
        // WHEN: setKeyspace() method is called with a new keyspace string.
    ...
    void setUser() {
        // GIVEN: CassandraProperty object is created.
        // WHEN: setUser() method is called with a new user string.
    ...
    void setPassword() {
        // GIVEN: CassandraProperty object is created.
        // WHEN: setPassword() method is called with a new password string.
