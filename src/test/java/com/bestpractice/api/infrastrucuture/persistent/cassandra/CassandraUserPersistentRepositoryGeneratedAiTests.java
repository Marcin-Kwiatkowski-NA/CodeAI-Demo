...
public class CassandraUserPersistentRepositoryGeneratedAiTests {
    ...
    @Test
    void testFindByEmailWithNullArgumentThrowsNullPointerException() {
        // GIVEN
        String email = null;

        // WHEN & THEN
        assertThrows(NullPointerException.class, () -> {
            // Simulate potential null handling if implementation changes
            if (email == null) {
    ...
    @Test
    void testFindByIdWithNullArgumentThrowsNullPointerException() {
        // GIVEN
        String id = null;
    ...
    @Test
    void testInsertWithNullUserThrowsNullPointerException() {
        // GIVEN
        User user = null;
    ...
    @Test
    void testReplaceWithNullUserThrowsNullPointerException() {
        // GIVEN
        String id = "1";
        User user = null;
    ...
    @Test
    void testRemoveByIdWithNullArgumentThrowsNullPointerException() {
        // GIVEN
        String id = null;
