...
public class CassandraUserPersistentRepositoryGeneratedAiTests {
    ...
    @Test
    void testFindByEmailWithNullInputDoesNotThrowException() {
        // GIVEN
        String email = null;

        // WHEN & THEN
        // The method itself does not throw exceptions, so we verify it returns null safely
        User result = repository.findByEmail(email);
    ...
    @Test
    void testFindByIdWithNullInputDoesNotThrowException() {
        // GIVEN
        String id = null;
    ...
    @Test
    void testInsertWithNullUserDoesNotThrowException() {
        // GIVEN
        User user = null;
    ...
    @Test
    void testReplaceWithNullUserDoesNotThrowException() {
        // GIVEN
        String id = "1";
        User user = null;
    ...
    @Test
    void testRemoveByIdWithNullInputDoesNotThrowException() {
        // GIVEN
        String id = null;
