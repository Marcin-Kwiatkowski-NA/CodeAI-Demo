...
public class MongoUserEntityGeneratedAiTests {
    ...
    void testConvertFromUserWithInvalidIdThrowsException() {
        // GIVEN
        User user = new User("invalid_object_id", "userInvalid", "invalid@example.com", "passInvalid");
    ...
    void testConvertToUserWithNullIdThrowsException() {
        ...
        mongoUserEntity.setUsername("nullIdUser");
        mongoUserEntity.setEmail("nullid@example.com");
        mongoUserEntity.setPassword("nullPass");
    ...
    void testConvertToUserWithEmptyFields() {
        ...
        assertNull(user.getEmail()); // email not set in convertTo()
    }
    ...
    void testConvertFromUserWithNullIdThrowsException() {
        // GIVEN
        User user = new User(null, "userNullId", "nullid@example.com", "passNull");
