...
public class MongoUserEntityGeneratedAiTests {
    ...
    void setEmail() {
        // GIVEN: A new MongoUserEntity instance
        // WHEN: The setEmail method is called with an email address
        // THEN: The email field of the MongoUserEntity is set to the provided email address
...
// Dummy extension to satisfy the requirement for @ExtendWith
