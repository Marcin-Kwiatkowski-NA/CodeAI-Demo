...
class MongoUserEntityGeneratedAiTests {
    ...
    void givenValidUser_whenConvertFrom_thenMongoUserEntityIsCreated() {
        // GIVEN
        User user = new User("64f1b2c3d4e5f67890123456", "testUser", "test@example.com", "securePassword");
    ...
    void givenValidMongoUserEntity_whenConvertTo_thenUserIsCreated() {
        // GIVEN
        ObjectId id = new ObjectId();
        mongoUserEntity = new MongoUserEntity(id, "testUser", "test@example.com", "securePassword");
