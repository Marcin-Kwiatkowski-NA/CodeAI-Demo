...
class UserGeneratedAiTests {
    ...
    @Test
    void givenValidUsername_whenSetUsername_thenUsernameShouldBeSetCorrectly() {
        // GIVEN
    ...
    @Test
    void givenValidConstructorArguments_whenCreateUser_thenFieldsShouldBeSetCorrectly() {
        // GIVEN
        String id = "12345";
        String username = "testUser";
        String email = "test@example.com";
