...
static class RedisPropertyExtension implements org.junit.jupiter.api.extension.ExtensionContext.TestRunnerFactory {
    @Override
...
static class RedisPropertyTestRunner {
    public RedisPropertyTestRunner(org.junit.jupiter.api.TestContext context) {
        super(context);
    }
}
